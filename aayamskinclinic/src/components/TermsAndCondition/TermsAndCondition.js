...
const TermsAndCondition = () => {
    ...
    return (<>
        <div> 
            ...
            <h1 class="terms-main-heading">Terms And Conditions</h1>
            <p class="terms-info">Welcome to our website. If you continue to browse and use this website, you are
                agreeing to comply with and be bound by the following terms and conditions of use, which together with
                our privacy policy govern AAYAM SKIN CLINIC(ASC’s) relationship with you in relation to this website. If
                you disagree with any part of these terms and conditions, please do not use our website. The term AAYAM
                SKIN CLINIC(“ASC”)’ or ‘us’ or ‘we’ refers to the owner of the website whose registered office is 3/1,
                Ravindra Nagar Old palasia Indore (M.P.). The term ‘you’ refers to the user or viewer of our website.
                The use of this website is subject to the following terms of use:</p>
            <ul class="terms-info">
                <li>The content of the pages of this website is for your general information and use only. It is subject
                    to change without notice and you agree to use the site for lawful purposes.</li>
                <li>Neither we nor any third parties provide any warranty or guarantee as to the accuracy, timeliness,
                    ...
                    inaccurances or errors and we expressly exclude liability for any such inaccuracies or errors to the
                ...
                <li>Your use of any information or materials on this website is entirely at your own risk, for which we
                    ...
                    information available through this website meet your specific requirements.</li>
                <li>This website contains material which is owned by or licensed to us. This material includes, but is
                    ...
                    than in accordance with the copyright notice, which forms part of these terms and conditions.</li>
                <li>All trademarks reproduced in this website, which are not the property of, or licensed to the
                    operator, are acknowledged on the website. You are prohibited from using any of the marks or logos
                    appearing throughout the site without permission from us, except as permitted by applicable Law.
                </li>
